...
public class SettingsHelper {
	...
	public SettingsHelper() {
		mXPreferences = new XSharedPreferences("com.haoutil.xposed.haoxperia");
		mXPreferences.makeWorldReadable();
		this.reload();
	}
	
	public SettingsHelper(Context context) {
		this.mPreferences = context.getSharedPreferences("com.haoutil.xposed.haoxperia_preferences", 1);
	}
